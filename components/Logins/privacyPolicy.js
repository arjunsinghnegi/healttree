...
import { getPrivacyPolicy } from "../../actions/staticPagesActions";
import Loader from "../common/loader";
class PrivacyPlicay extends Component {
  constructor(props) {
    super(props);
...
export default connect(mapStateToProps, { getPrivacyPolicy })(PrivacyPlicay);
