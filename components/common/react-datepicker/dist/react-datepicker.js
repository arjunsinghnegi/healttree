	  ...
	  function DatePicker(props) {
	    ...
	    _this.calcInitialState = function () {
	      ...
	      var boundedPreSelection = minDate && defaultPreSelection.isBefore(minDate) ? minDate : maxDate && defaultPreSelection.isAfter(maxDate) ? maxDate : defaultPreSelection;
				...
				_this.setState({min_date: minDate, max_date: maxDate});
	      return {
	        open: false,
	        preventFocus: false,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function generateYears(year, noOfYear) {
	  ...
	  for (var i = 2 * noOfYear; i > 0; i--) {
			if(year + noOfYear - i <= currYear){
	...
	var YearDropdownOptions = function (_React$Component) {
	  ...
	  function YearDropdownOptions(props) {
	    ...
	    _this.state = {
	      yearsList: _this.props.scrollableYearDropdown ? generateYears(_this.props.year, 50) : generateYears(_this.props.year, 50)
	    };
	    return _this;
	  }
