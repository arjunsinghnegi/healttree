  ...
  //  const { handleSubmit } = this.props;
    return (
      ...
      <div className="col-sm-12">
        <h2 className="page-title">Gene Expression Profile Test</h2>
        <span className="back"><Link to="/fish-test"><i className="fa fa-angle-double-left" aria-hidden="true"></i> Back</Link></span>
        <ol className="breadcrumb">
          <li className="breadcrumb-item active"><Link to="/about-me">About Me</Link></li>
          <li className="breadcrumb-item">Gene Expression Profile Test</li>
        </ol>
        <form>
        <div className="form-group row align-items-center">
          <label htmlFor="inputPassword3" className="col-sm-12 col-md-12 col-lg-6 col-form-label"> Do you want to manually enter the results from your gene expression profile test performed, either at diagnosis or after relapse? The name of the test may be Signal Genetics, MyPRS or Skyline-92.</label>
